...
void SandSurfaceRenderer::setHeightKey(int key, float height) {
	heightMap.setHeightKey(key , height);
}
void SandSurfaceRenderer::drawColorLine(bool state) {
	drawContourLines = state;
}
