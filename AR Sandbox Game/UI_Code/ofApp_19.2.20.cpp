...
void ofApp::setup(){
	...
	Lunar_Starter = new ofxDatGui(115, 700); //Button for lunar
    ...
    Triangle_Starter = new ofxDatGui(130, 1480);
	Triangle_Starter->addButton("     ");//4

    Circle_Starter = new ofxDatGui(130, 1530);
	Circle_Starter->addButton("       ");//5

	Square_Starter = new ofxDatGui(130, 1580);
	Square_Starter->addButton("      ");//6

	ShapeHeart_Starter = new ofxDatGui(130, 1630);
	ShapeHeart_Starter->addButton("    ");//7 

	ShapeUK_Starter = new ofxDatGui(130, 1430);//map
	ShapeUK_Starter->addButton("    ");//7 

	Leardboard_Starter = new ofxDatGui(670, 1580);
...
void ofApp::drawPcjWindow(ofEventArgs &args) {
	...
	ofDrawCircle(230, 520, 150);
	ofSetCircleResolution(1000);
	//ofDrawBitmapString("Moon",220,700);
	//The part of the lunar
	ofSetLineWidth(4);
	ofDrawLine(120, 500, 140, 450);
	ofDrawLine(140, 450, 155, 500);
	ofDrawLine(155, 500, 175, 450);
	ofDrawLine(175, 450, 190, 500);
	ofDrawCircle(215, 475, 25);
	ofDrawCircle(265, 475, 25);
	ofDrawLine(295, 450, 295, 500);
	ofDrawLine(295, 455, 320, 455);
	ofDrawLine(320, 500, 320, 455);

	ofSetLineWidth(4);
	ofSetCircleResolution(20);
	ofDrawCircle(150, 515, 10);
	ofDrawCircle(270, 620, 20);
	ofDrawCircle(200, 550, 30);
	ofDrawCircle(280, 560, 25);
	ofDrawCircle(450,790,45);
	ofDrawCircle(460,810,10);
	//The part of the sandbox
	ofFill();
	ofSetColor(100, 149, 237);
	ofDrawEllipse(680, 650, 130, 35);

	ofSetColor(0,191,255);
	ofDrawEllipse(720,635,150,40);

	ofSetColor(176, 266, 255);        //LightSkyBlue1
	ofDrawEllipse(750, 610, 160, 50);

	ofSetColor(67, 205, 128);
	ofDrawEllipse(780, 570, 170, 60);
	ofSetColor(46, 139, 87);            //SeaGreen4
	ofDrawEllipse(810, 540, 190, 70);  

	ofSetColor(238, 232, 170);          //PaleGoldenrod
	ofDrawEllipse(830, 510, 200, 75);

	ofSetColor(244, 164, 96);           //SandyBrown
	ofDrawEllipse(850, 470, 230, 80);
	
	ofSetColor(205, 38, 38);           //Firebrick3
	ofDrawEllipse(870, 430, 250, 90);
	
	//shape game
	ofSetColor(99,184,255); //Triangle
	ofDrawTriangle(430,1470,450,1510,410,1510);

	ofSetColor(193,255,193);  //Circle
	ofDrawCircle(430,1545,20);

	ofSetColor(79,79,79);   //Rectangle
	ofDrawRectangle(420,1580,30,30);

	ofSetColor(255,174,184);  //heart shape
	ofDrawCircle(430, 1650, 17.5);
	ofDrawCircle(455,1650,17.5);
	ofDrawTriangle(415,1660,470,1660,442.5,1690);
	
	ofSetColor(0,255,255);
	ofSetLineWidth(3);
	ofDrawLine(410, 1430, 410, 1455);   //u
	ofDrawLine(410, 1455, 425, 1455);
	ofDrawLine(425, 1457, 425, 1430);

	ofDrawLine(440, 1430, 440, 1455);//k
	ofDrawLine(440, 1440, 455, 1430);
	ofDrawLine(440, 1440, 455, 1455);
	//ofDrawLine(140,1410)
	ofNoFill();
	ofSetColor(191,239,255);
	ofDrawRectangle(90, 980, 370, 420);
	ofFill();
	ofSetColor(0, 191, 255);
	ofDrawTriangle(150, 1000, 130, 1300, 230, 1200);
	ofSetColor(0, 0, 139);
	ofSetCircleResolution(100);
	ofDrawCircle(270,1100,45);
	...
	ofSetColor(169, 169, 169);
	ofSetLineWidth(6);
	ofDrawRectangle(113, 698, 275, 30);
	//sandbox start
	ofSetColor(0, 191, 255);
	ofSetLineWidth(6);
